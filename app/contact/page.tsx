  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
      <header className="mb-14 text-center">
        ...
        <h1 className="mt-3 font-serif text-4xl text-ink md:text-5xl">Contact Us</h1>
      </header>
      ...
      <div className="grid gap-14 lg:grid-cols-2">
        ...
        <div className="space-y-10">
          <div>
            <h2 className="font-serif text-xl text-ink">Book an appointment</h2>
            <p className="mt-3 text-sm text-muted">Therapy slots: Mon–Sat, 10 AM – 7 PM IST</p>
          ...
          <ul className="space-y-4 text-sm text-muted">
            <li className="flex gap-3">
              ...
              <span>1X Wellness & Cyber Campus, New Delhi, India</span>
            </li>
            <li className="flex gap-3">
            ...
            <li className="flex gap-3">
              ...
              <a href="mailto:contact@1x-dr-ayesha.com" className="hover:text-ink">
                contact@1x-dr-ayesha.com
              </a>
            </li>
            <li className="flex gap-3">
              <FiInstagram className="shrink-0" />
              <span>@1x.dr.ayesha</span>
            </li>
          </ul>
