  ...
  return (
    <div>
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        {hasFilter ? (
          <Link href={ADMIN.orders} className="text-sm font-medium text-mauve-deep hover:underline">
            Clear filter
          </Link>
        ) : null}
      </div>
              ...
              {orders.map((o) => {
                ...
                return (
                  <tr key={o._id} className="border-b border-rose-50">
                    ...
                    <td className="px-4 py-3">
                      <Link href={ADMIN.order(o._id)} className="text-mauve-deep hover:underline">
                        View
                      </Link>
                    </td>
                  </tr>
