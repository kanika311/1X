...
export default function OrderDetailPage() {
  ...
  if (!order) {
    return (
      <div>
        ...
        <Link href={ADMIN.orders} className="mt-4 inline-block text-mauve-deep hover:underline">
          ← Back to orders
        </Link>
      </div>
    );
  ...
  return (
    <div className="max-w-3xl">
      <Link href={ADMIN.orders} className="text-sm text-mauve-deep hover:underline">
        ← Orders
      </Link>
