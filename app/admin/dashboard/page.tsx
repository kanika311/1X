  ...
  return (
    <div>
      ...
      <div className="mt-12 flex flex-wrap gap-3">
        <Link href={ADMIN.productsNew} className="rounded-lg bg-mauve-deep px-5 py-2.5 text-sm font-semibold text-white">
          + Add product
        </Link>
        <Link href={ADMIN.offersNew()} className="rounded-lg border border-rose-200 bg-white px-5 py-2.5 text-sm font-semibold">
          + Add offer
        </Link>
        <Link href={ADMIN.orders} className="rounded-lg border border-rose-200 bg-white px-5 py-2.5 text-sm font-semibold">
          View orders
        </Link>
      </div>
      {!stats ? (
