...
const NAV = [
  ...
  { href: ADMIN.products, label: "Services & Courses" },
  { href: ADMIN.offers, label: "Gift cards" },
  { href: ADMIN.siteContent, label: "Site content" },
  { href: ADMIN.contactInquiries, label: "Contact messages" },
  { href: ADMIN.newsletter, label: "footer-signup" },
    ...
    <div className="flex min-h-dvh">
      ...
      >
        ...
        <div className="border-t border-rose-100 pt-4 text-xs text-muted">
          ...
          <p className="truncate">{admin?.email || admin?.number}</p>
          <button
            type="button"
