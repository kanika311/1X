...
import { listMedia, uploadImageFile, type MediaItem } from "@/lib/admin/upload";
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-[10px] text-muted">
        Stored as <code className="text-ink">/uploads/…</code> — served from this app at{" "}
        <code className="text-ink">/uploads/filename</code>.
      </p>
